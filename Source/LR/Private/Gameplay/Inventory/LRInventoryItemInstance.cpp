...
ULRInventoryItemInstance::ULRInventoryItemInstance(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}
...
void ULRInventoryItemInstance::SetItemDef(TSubclassOf<ULRInventoryItemDefinition> InDef)
{
	ItemDef = InDef;
}
