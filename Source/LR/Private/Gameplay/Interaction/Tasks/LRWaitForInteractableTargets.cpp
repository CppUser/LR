...
#include "Gameplay/Interaction/Tasks/LRWaitForInteractableTargets.h"

#include "AbilitySystemComponent.h"
#include "Gameplay/Interaction/ILRInteractableTarget.h"


ULRWaitForInteractableTargets::ULRWaitForInteractableTargets(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}


void ULRWaitForInteractableTargets::LineTrace(FHitResult& OutHitResult, const UWorld* World, const FVector& Start,
...
void ULRWaitForInteractableTargets::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params,
...
bool ULRWaitForInteractableTargets::ClipCameraRayToAbilityRange(FVector CameraLocation, FVector CameraDirection,
...
void ULRWaitForInteractableTargets::UpdateInteractableOptions(const FInteractionQuery& InteractQuery,
