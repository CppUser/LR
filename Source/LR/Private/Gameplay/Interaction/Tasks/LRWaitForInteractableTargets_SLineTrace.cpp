...
#include "Gameplay/Interaction/Tasks/LRWaitForInteractableTargets_SLineTrace.h"

#include "Gameplay/Interaction/LRInteractionStatics.h"

ULRWaitForInteractableTargets_SLineTrace::ULRWaitForInteractableTargets_SLineTrace(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void ULRWaitForInteractableTargets_SLineTrace::Activate()
{
	SetWaitingOnAvatar();
...
ULRWaitForInteractableTargets_SLineTrace* ULRWaitForInteractableTargets_SLineTrace::
...
{
	ULRWaitForInteractableTargets_SLineTrace* MyObj = NewAbilityTask<ULRWaitForInteractableTargets_SLineTrace>(OwningAbility);
...
void ULRWaitForInteractableTargets_SLineTrace::OnDestroy(bool AbilityEnded)
{
...
void ULRWaitForInteractableTargets_SLineTrace::PerformTrace()
{
	...
	ULRInteractionStatics::AppendInteractableTargetsFromHitResult(OutHitResult, InteractableTargets);
