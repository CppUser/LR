...
#include "LRInventoryItemDefinition.h"
...
public:
	...
	TSubclassOf<ULRInventoryItemDefinition> GetItemDef() const
	{
		return ItemDef;
	}
...
private:
	void SetItemDef(TSubclassOf<ULRInventoryItemDefinition> InDef);
private:
	UPROPERTY()
