...
#include "LRAbilitySet.generated.h"
...
public:
	...
	void TakeFromAbilitySystem(ULRAbilitySystemComponent* ASC);
...
class LR_API ULRAbilitySet : public UPrimaryDataAsset
{
	GENERATED_BODY()
public:
	void GiveToAbilitySystem(ULRAbilitySystemComponent* ASC, FAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
protected:
